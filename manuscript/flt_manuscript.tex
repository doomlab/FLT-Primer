...
\caption{\label{tab:tab1}Tidy Data Caption}
\begin{tabular}{cc}
\toprule
word & \multicolumn{1}{c}{answer}\\
\midrule
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:tab2}Tidy Data Caption}
\begin{tabular}{ccccc}
\toprule
token & \multicolumn{1}{c}{tag} & \multicolumn{1}{c}{lemma} & \multicolumn{1}{c}{lttr} & \multicolumn{1}{c}{wclass}\\
\midrule
is & VBZ & be & 2.00 & verb\\
are & VBP & be & 3.00 & verb\\
trained & VBN & train & 7.00 & verb\\
lots & NNS & lot & 4.00 & noun\\
seats & NNS & seat & 5.00 & noun\\
wings & NNS & wing & 5.00 & noun\\
\bottomrule
\end{tabular}
\end{threeparttable}
\end{center}
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:tab3}Tidy Data Caption}
\begin{tabular}{cc}
\toprule
word & \multicolumn{1}{c}{answer}\\
\midrule
...
\begin{center}
\begin{threeparttable}
\caption{\label{tab:tab4}Tidy Data Caption}
\begin{tabular}{ccc}
\toprule
Word & \multicolumn{1}{c}{Feature} & \multicolumn{1}{c}{Frequency}\\
\midrule
zebra & be\_horse & 1\\
...
kable(zebra{[}1:10, {]}, \enquote{latex}, booktabs = T, row.names = F) \%\textgreater{}\% kable\_styling(position = \enquote{center})
