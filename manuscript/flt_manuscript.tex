...
\authornote{Erin M. Buchanan \url{https://orcid.org/0000-0002-9689-4189}; Simon De Deyne \url{https://orcid.org/0000-0002-7899-6210}; Maria Montefinese \url{https://orcid.org/0000-0002-7685-1034}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\NormalTok{lemma }\OperatorTok{%in%}\StringTok{ }\KeywordTok{stopwords}\NormalTok{(}\DataTypeTok{language =} \StringTok{"en"}\NormalTok{, }\DataTypeTok{source =} \StringTok{"snowball"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
