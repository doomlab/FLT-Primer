...
You can load the entire set of libraries for this tutorial as shown below using `dependencies.R` found online^[A `packrat` project compilation is available on GitHub for reproducibility [@Ushey2018]]. 
...
sample_sizes <- as.data.frame(tapply(X_master$word, X_master$word, length))
